...
#ifndef PROTOBUF_example_2epb__INCLUDED
#define PROTOBUF_example_2epb__INCLUDED
...
// optional uint32 index = 1;
inline bool Channel::has_index() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Channel::set_has_index() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Channel::clear_has_index() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline ::google::protobuf::uint32 Channel::index() const {
  return index_;
}
inline void Channel::set_index(::google::protobuf::uint32 value) {
  set_has_index();
  index_ = value;
}
...
#endif  // PROTOBUF_example_2epb__INCLUDED
